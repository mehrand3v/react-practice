    ...
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="space-y-2">
          ...
          <input
            ...
            required
            className="appearance-none block w-full px-3 py-2.5 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
      ...
      <div className="mt-8 flex justify-center">
        <div className="inline-flex items-center text-gray-700">
          ...
          <span className="font-medium">Your App Name</span>
        </div>
      </div>
    </div>
  );
